...
class ApplicationsTest < ApplicationSystemTestCase
  ...
  test "creating a Application" do
    ...
    fill_in "Adresa boravišta", with: @application.adresa_boravišta
    fill_in "Broj telefona", with: @application.broj_telefona
    fill_in "Datum rođenja", with: @application.datum_rođenja
    fill_in "Email", with: @application.email
    fill_in "Ime", with: @application.ime
    fill_in "Job", with: @application.job_id
    fill_in "Prezime", with: @application.prezime
    fill_in "Stručna sprema", with: @application.stručna_sprema
